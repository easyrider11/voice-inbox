// Minimal service worker: cache the shell for installability/offline UI.
// API calls (/v1, /health) always go to the network.
...
self.addEventListener("fetch", (e) => {
  ...
  if (url.pathname.startsWith("/v1/") || url.pathname === "/health" || e.request.method !== "GET") return;
